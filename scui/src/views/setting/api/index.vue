...
<!--					</div>-->
				...
				<el-main class="nopadding">
					<scTable ref="table" :apiObj="apiObj" @selection-change="selectionChange" stripe remoteSort remoteFilter>
						...
						<el-table-column label="请求方式" prop="method" width="" sortable='custom' column-key="filterUserName" :filters="[{text: '系统账号', value: '1'}, {text: '普通账号', value: '0'}]"></el-table-column>
						<el-table-column label="访问路径" prop="path" width="" sortable='custom'></el-table-column>
						<el-table-column label="所属类别" prop="category" width="" sortable='custom'></el-table-column>
	...
	export default {
		...
		methods: {
			...
			async table_del(row, index){
				console.log(index)
				var reqData = {apiIds: [row.ID]}
				var res = await this.$API.system.api.delete.delete(reqData);
				if(res.code == 200){
